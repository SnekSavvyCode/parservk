...
from .datacorrector import DataCorrector
from .models import ParserVK
from .logger import LOGGER
from .poolmanager import PoolManager

_DATACORRECTOR = DataCorrector(None)
...
class Base:
	...
	def __init__(self, data: ParserVK) -> None:
		if not isinstance(data, ParserVK):
			raise ValueError("The data must be of the ParserVK type.")
